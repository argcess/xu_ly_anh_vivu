...
# load the image
first_read_image = cv2.imread("rash1.jpg")#rash3

#convert image from BGR to RGB
image = cv2.cvtColor(first_read_image, cv2.COLOR_BGR2RGB)  # red , green , blue 
...
#get mean color value of the image (lấy giá trị màu trung bình của hình ảnh)
mean_color = cv2.mean(image)# lấy giá trị khung ngoài ô trung tâm, lấy trung bình giá trị màu red , green ,blue ,alpha
#print the mean
...
#print(addition_of_row_numbers_having_dark_pixels_in_each_column)
...
for x in range(0,columns):
    ...
    for y in range(0,rows):
        ...
        #time.sleep(0.1)# a[0]= a[0] + 0 = 0 , a[0]  = a[0] + 1 = 1 , a[0] = a[0] + 2 = 2?><M<b n n     
        #print(addition_of_row_numbers_having_dark_pixels_in_each_column[x],end = " ")    
